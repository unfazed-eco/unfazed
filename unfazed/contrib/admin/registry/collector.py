...
if t.TYPE_CHECKING:
    from .models import BaseAdmin, ModelAdmin, ModelInlineAdmin  # pragma: no cover


T = t.TypeVar("T", bound=t.Union["BaseAdmin", "ModelAdmin", "ModelInlineAdmin"])


class AdminCollector:
    def __init__(self) -> None:
        self._store: t.Dict[str, T] = {}
