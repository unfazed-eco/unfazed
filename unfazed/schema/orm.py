...
class SqliteCredential(BaseModel):
    ...
    journal_mode: str | None = Field(None, alias="JOURNAL_MODE")
    journal_size_limit: int | None = Field(None, alias="JOURNAL_SIZE_LIMIT")
    foreign_keys: str | None = Field(None, alias="FOREIGN_KEYS")
...
class BaseCredential(BaseModel):
    ...
    minsize: int | None = Field(None, alias="MIN_SIZE")
    maxsize: int | None = Field(None, alias="MAX_SIZE")
    ssl: t.Optional[bool] = Field(None, alias="SSL")


class PgsqlCredential(BaseCredential):
    max_queries: int | None = Field(None, alias="MAX_QUERIES")
...
class MysqlCredential(BaseCredential):
    connect_timeout: int | None = Field(None, alias="CONNECT_TIMEOUT")
    echo: bool | None = Field(None, alias="ECHO")
    charset: str | None = Field(None, alias="CHARSET")
...
class Database(BaseModel):
    ...
    apps: t.Dict[str, AppModels] | None = Field(None, alias="APPS")
    routers: t.List[str] | None = Field(None, alias="ROUTERS")
    use_tz: bool | None = Field(None, alias="USE_TZ")
